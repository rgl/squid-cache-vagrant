...
public static class Proxy
{
    ...
    public static bool Set(bool EnableProxy)
    {
        return Set(EnableProxy, false, "", "", "","");
    }

    public static bool Set(string ProxyAddress)
    {
        return Set(true, false, ProxyAddress, "", "","");
    }

    public static bool Set(string ProxyAddress, string ProxyExceptions)
    {
        return Set(true, false, ProxyAddress, ProxyExceptions,"","");
    }
    
    public static bool SetAutoConfigURL(string AutoConfigURL)
    {
        return Set(false, false, "", "", AutoConfigURL,"");
    }
    ...
    /// <returns></returns>
    public static bool Set(bool EnableProxy, bool EnableAutoDetect, string ProxyAddress, string ProxyExceptions, string AutoConfigURL, string ConnectionName="")
    {
        ...
        int returnvalue = NativeMethods.InternetSetOption(
            IntPtr.Zero,
...
'@
[Proxy]::Set('http://proxy.example.com:3128', '<local>') | Out-Null

# configure WinHTTP too.
